...
from v4_utils.autoanchor import check_anchors
from v4_utils.datasets import create_dataloader
from v4_utils.v4_general import labels_to_class_weights, increment_path, labels_to_image_weights, init_seeds, \
...
from v4_utils.google_utils import attempt_download
from v4_utils.loss import compute_loss
from v4_utils.plots import plot_images, plot_labels, plot_results, plot_evolution
from v4_utils.torch_utils import ModelEMA, select_device, intersect_dicts, torch_distributed_zero_first

logger = logging.getLogger(__name__)

try:
    import wandb
    print('wandb is implemented')
except ImportError:
    wandb = None
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg//yolov4-pacsp-x.cfg', help='model.yaml path')
    parser.add_argument('--data', type=str, default='v4_data/custon.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='v4_data/hyp.scratch.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--name', default='yolov4/train', help='save to project/name')
