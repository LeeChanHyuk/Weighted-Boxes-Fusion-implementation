...
from yolov4.utils.google_utils import attempt_load as v4_attempt_load
from utils.general import (
    check_img_size, non_max_suppression,  scale_coords, xyxy2xywh, strip_optimizer)
from yolov4.utils.general import apply_classifier
from yolov4.utils.plots import plot_one_box
from utils.torch_utils import select_device
from yolov4.utils.torch_utils import load_classifier, time_synchronized
...
def run(data,
        ...
        yolov4_weight = ROOT /'yolov4/weights/v4_best.pt',
        yolov4_cfg = ROOT / 'yolov4/cfg/yolov4-pacsp-x.cfg',
        yolov5_weight = ROOT / 'v5_best.pt',
        model=None,
        dataloader=None,
        save_dir=Path(''),
        plots=True,
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        t3 = time_sync()
        v5_out = non_max_suppression(v5_out, conf_thres, iou_thres, labels=lb, multi_label=True, agnostic=single_cls)
        v4_out = non_max_suppression(v4_out, conf_thres, iou_thres, labels=lb, multi_label=True, agnostic=single_cls)
        dt[2] += time_sync() - t3
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/custon.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--yolov4_weight', nargs='+', type=str, default=ROOT/'yolov4/weights/v4_best.pt')
    parser.add_argument('--yolov4_cfg', nargs='+', type=str, default=ROOT/'yolov4/cfg/yolov4-pacsp-x.cfg')
    parser.add_argument('--yolov5_weight', nargs='+', type=str, default=ROOT/'v5_best.pt')
