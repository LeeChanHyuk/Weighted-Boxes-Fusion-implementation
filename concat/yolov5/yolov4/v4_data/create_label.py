...
data_path = '/content/drive/MyDrive/illegal_object_detection/PyTorch_YOLOv4/dataset/whole_data'
save_path = '/content/drive/MyDrive/illegal_object_detection/PyTorch_YOLOv4/dataset'
...
def make_data_label_file(xs, jsons, txtname, base_path, save_path):
    ...
    for i in range(len(xs)):
        image_name = xs[i]
        json_name = jsons[i]
        f.write(os.path.join(base_path, image_name+' '))
