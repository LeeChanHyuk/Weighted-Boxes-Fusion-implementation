...
def run(data,
    ...
    data = '/home/ddl/git/hackathon_project/yolov5-master/data/custon.yaml'
    weights = ROOT / 'v5_best.pt'
    ...
    if training:  # called by train.py
        ...
        # Load VOLOv4 model
        cfg = '/home/ddl/git/hackathon_project/concat/yolov5/yolov4/cfg/yolov4-pacsp-x.cfg' # must append
        v4_weights = '/home/ddl/git/hackathon_project/concat/yolov5/yolov4/weights/v4_best.pt'
