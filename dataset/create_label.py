...
splited_data_path = '/home/ddl/git/hackathon_project/dataset/images'
save_path = '/home/ddl/git/hackathon_project/dataset'
...
def make_data_label_file(xs, jsons, txtname, base_path, save_path):
    ...
    for i in range(len(xs)):
        image_name = xs[i]
        json_name = jsons[i]
        f.write(os.path.join(splited_data_path, image_name))
